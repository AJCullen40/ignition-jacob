...
// Covers all NANP area codes assigned to US states + DC + territories
export const AREA_CODE_TO_STATE: Record<string, string> = {
  ...
  "386": "Florida", "407": "Florida", "561": "Florida", "689": "Florida",
  "727": "Florida", "754": "Florida", "772": "Florida", "786": "Florida",
  "813": "Florida", "850": "Florida", "863": "Florida", "904": "Florida",
  "941": "Florida", "954": "Florida",
  // Georgia
  "229": "Georgia", "404": "Georgia", "470": "Georgia", "478": "Georgia",
  "678": "Georgia", "706": "Georgia", "762": "Georgia", "770": "Georgia",
  "912": "Georgia", "943": "Georgia",
  // Hawaii
  "808": "Hawaii",
  // Idaho
  "208": "Idaho", "986": "Idaho",
  ...
  "630": "Illinois", "708": "Illinois", "730": "Illinois", "773": "Illinois",
  ...
  // Louisiana
  "225": "Louisiana", "318": "Louisiana", "337": "Louisiana", "504": "Louisiana",
  "985": "Louisiana",
  // Maine
  "207": "Maine",
  // Maryland
  "227": "Maryland", "240": "Maryland", "301": "Maryland", "410": "Maryland",
  "443": "Maryland", "667": "Maryland",
  // Massachusetts
  ...
  "363": "New York", "516": "New York", "518": "New York", "585": "New York",
  "607": "New York", "631": "New York", "646": "New York", "680": "New York",
  "716": "New York", "718": "New York", "838": "New York", "845": "New York",
  "914": "New York", "917": "New York", "929": "New York", "934": "New York",
  // North Carolina
  "252": "North Carolina", "336": "North Carolina", "472": "North Carolina",
  "704": "North Carolina", "743": "North Carolina", "828": "North Carolina",
  "910": "North Carolina", "919": "North Carolina", "980": "North Carolina",
  "984": "North Carolina",
  // North Dakota
  "701": "North Dakota",
  // Ohio
  "216": "Ohio", "220": "Ohio", "234": "Ohio", "326": "Ohio", "330": "Ohio",
  "380": "Ohio", "419": "Ohio", "440": "Ohio", "513": "Ohio",
  ...
  "307": "Wyoming",
  // US Territories
  "340": "US Virgin Islands", "670": "Northern Mariana Islands",
  "671": "Guam", "684": "American Samoa", "787": "Puerto Rico", "939": "Puerto Rico",
};

export function phoneToState(phone: string): string {
  ...
  return AREA_CODE_TO_STATE[areaCode] ?? "International";
}
